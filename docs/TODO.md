...
| T-134 | Convertir `Fuentes`, `Metodología` e `Info` de drawer lateral a pestañas centrales. | ✅ **Completado 2026-05-10** — pestañas individuales en el área principal; `Eventos` restaura el carril operativo y smoke valida el estado. | 2026-05-10 |
