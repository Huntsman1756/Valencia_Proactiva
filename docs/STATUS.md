...
- **R-17:** navegación integrada en header: `Fuentes`, `Metodología` e `Info` se muestran como pestañas centrales del área principal. Añadidas tareas T-120 (Valhalla + `exclude_polygons`) y T-121 (Modo Alerta solo con fuentes oficiales verificadas).
