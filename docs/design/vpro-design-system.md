...
- Los paneles informativos son drawers no modales: no bloquean la lista de eventos, no fuerzan `overflow: hidden` en el body y deben enfocar el boton de cierre al abrir.
