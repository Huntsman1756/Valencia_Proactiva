...
def test_export_all_writes_geojson_and_csv(monkeypatch):
        ...
        [
            {
                ...
                "event_title": "PUENTE DEL ÁNGEL CUSTODIO HACIA E. BOSCÁ?",
                "severity": 3,
    ...
    try:
        ...
        assert (
            geojson["features"][0]["properties"]["event_title"]
            == "PUENTE DEL ÁNGEL CUSTODIO HACIA E. BOSCÁ"
        )
        ...
        assert rows[0]["event_title"] == "PUENTE DEL ÁNGEL CUSTODIO HACIA E. BOSCÁ"
        ...
        assert latest_events["events"][0]["title"] == "PUENTE DEL ÁNGEL CUSTODIO HACIA E. BOSCÁ"
