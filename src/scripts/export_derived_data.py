...
from ingestion.normalizer import clean_public_text  # noqa: E402
    ...
    features = [
        {
            ...
            "properties": {
                ...
                "event_title": clean_public_text(row["event_title"]),
...
def _event_payload(row: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        "id": event_id,
        "type": row["type"],
        "title": clean_public_text(row["title"]),
        "description": clean_public_text(row["description"] or ""),
